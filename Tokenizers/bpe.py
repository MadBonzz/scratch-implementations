...
class BPE:
    def __init__(self, vocab_size : int, min_freq : int, initial_alphabet : list[chr] = None, byte_fallback : bool = False, unk_token : str = None):
...
bpe = BPE(2048, 10, initial_alphabet=chars, unk_token='UNK')
